...
public class Scroll {
	...
	public static void scrollKeys(AppiumDriver<MobileElement> driver, String[] list) {
	...
	public static void scrollChecker(AppiumDriver<MobileElement> driver, String[] list) {
		System.out.println("Starting the process");
		for (int i = 0; i < list.length; i++) {
	...
	private static void scrollAndSearch(AppiumDriver<MobileElement> driver, String value, MobileElement me, Boolean direction) {
	...
	// Code here shouldn't be modified
	private static void swipe(AppiumDriver<MobileElement> driver, String start, String end, Boolean up) {
		String direction;
		if (up) {
	...
	// dynamically selecting each scroll wheel
	// Code here shouldn't be modified
	public static void scrollKeys1(AppiumDriver<MobileElement> driver, String[] list) {
		System.out.println("Starting the process");
		for (int i = 0; i < list.length; i++) {
